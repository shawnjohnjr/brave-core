...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
    ...
    { "braveNewTabNewTabPageShowsDashboardWithImages",
      IDS_SETTINGS_NEW_TAB_NEW_TAB_PAGE_SHOWS_DASHBOARD_WITH_IMAGES },
    { "braveNewTabNewTabPageShowsHomepage",
      IDS_SETTINGS_NEW_TAB_NEW_TAB_PAGE_SHOWS_HOMEPAGE },
    { "braveNewTabNewTabPageShowsBlankPage",
      IDS_SETTINGS_NEW_TAB_NEW_TAB_PAGE_SHOWS_BLANK_PAGE },
